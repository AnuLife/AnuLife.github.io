...
$(".note_guide").mouseenter(function(){
    ...
    $(".guidePic").css({ backgroundImage: "url('https://www.imageoss.com/images/2021/08/23/YfLHgA4bce712fc8cb83c9.jpg')" });
})
...
$(".jay_guide").mouseenter(function(){
    ...
    $(".guidePic").css({ backgroundImage: "url('https://www.imageoss.com/images/2021/08/24/2145F6682FBCE287815AF6DC59D0C5A5518de00258cb8630.png')" });
})
$(".home_guide").mouseenter(function(){
    $('.zhegaid').stop().animate({ width: "100%" }, 150);
    $('.zhegaia,.zhegaib,.zhegaic').stop().animate({ width: "0" }, 150);
    $(".guidePic").css({ backgroundImage: "url('https://www.imageoss.com/images/2021/08/23/waoh6O8b7ea1e3474439ac.jpg')" });
})
